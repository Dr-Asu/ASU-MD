  ...
  start: async (
    ...
    switch (inputCMD) {
      ...
      case "toimage":
        ...
        await doReact("🎴");
        let mediaMess = await ASU.downloadAndSaveMediaMessage(quoted);
      ...
      case "tomp4":
        ...
        await doReact("🎴");
        let mediaMess2 = await ASU.downloadAndSaveMediaMessage(quoted);
      ...
      case "togif":
        ...
        await doReact("🎴");
        let mediaMess3 = await ASU.downloadAndSaveMediaMessage(quoted);
      ...
      case "tomp3":
        ...
        await ASU.sendPresenceUpdate("recording", m.from);
      ...
      case "tourl":
        ...
        let media5 = await ASU.downloadAndSaveMediaMessage(quoted);
        if (/image/.test(mime)) {
          await doReact("🔗");
      ...
      case "imgtopdf":
        if (/image/.test(mime)) {
          await doReact("📑");
          let mediaMess4 = await ASU.downloadAndSaveMediaMessage(quoted);
