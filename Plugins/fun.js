    ...
    switch (inputCMD) {
      case "truth":
        ...
        const truth = [
          ...
          "do you love the bot creator Dr-ASU?",
      ...
      case "dare":
        ...
        const dare = [
          ...
          "say i love the bot owner Dr-ASU through voice note",
      ...
      case "coinflip":
        ...
        if (result === 1) {
          await ASU.sendMessage(m.from, { text: "Heads" }, { quoted: m });
        } else {
          await ASU.sendMessage(m.from, { text: "Tails" }, { quoted: m });
        }
        break;
      ...
      case "charactercheck":
        ...
        let ASUtext4 = `Character Check Of : @${
