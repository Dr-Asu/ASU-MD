...
module.exports = {
  ...
  start: async (ASU, m, { inputCMD, text, doReact, prefix, pushName }) => {
    switch (inputCMD) {
      case "google":
      case "search":
        if (!text) {
      ...
      case "lyrics":
        ...
        let resText2 = `  *『  ⚡️ Lyrics Search Engine ⚡️  』*\n\n\n_Search Term:_ *${text}*\n\n\n*📍 Lyrics:* \n\n${lyrics}\n\n\n_*Powered by:*_ *Scrappy API - by Dr-ASU*\n\n_*Url:*_ https://github.com/Dr-asu \n`;
        await ASU.sendMessage(
          m.from,
          {
            image: {
    ...
    var txt2 = `*🏮 YouTube Search Engine 🏮*\n\n_🧩 Search Term:_ *${text}*\n\n*📌 Total Results:* *${search.all.length}*\n`;*/
        ...
        ASU.sendMessage(m.from, buttonMessage, { quoted: m });
        break;
